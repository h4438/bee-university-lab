...
def get_university_code():
    ...
    for idx, e_tr in enumerate(soup.select(
            '.code-shol > table > tr')):
        if idx > 0:
...
if __name__ == '__main__':
    ...
    # university_data = extract_data_diemchuan(
    #     url_diemchuan=f'https://diemthi.tuyensinh247.com/diem-chuan/dai-hoc-cong-nghe-QHI.html',
    #     university_meta=None)
    ...
    #file_university_diemchuan_path = "./testout/diemchuan_2020.gz"
